        ...
        <div className="inner-boundry border w-full h-full rounded-[2em] overflow-hidden">
          ...
          <div className="w-full h-full overflow-y-scroll no-scrollbar pb-12">
            ...
            <div className="button-wrapper mx-auto w-full flex flex-col gap-4 px-4 py-4 mt-8">
              <button className="flex flex-row gap-2 items-center justify-center bg-slate-800 text-white px-4 py-2 rounded-lg">
                {/* <span>Image</span> */}
              ...
              <button className="flex flex-row gap-2 items-center justify-center bg-red-600 text-white px-4 py-2 rounded-lg">
                {/* <span>Image</span> */}
              ...
              <button className="flex flex-row gap-2 items-center justify-center bg-blue-600 text-white px-4 py-2 rounded-lg">
                {/* <span>Image</span> */}
